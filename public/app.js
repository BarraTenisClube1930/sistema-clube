  ...
  return `
    <div class="dep-card">
      ...
      <div class="grid2" style="margin-top:8px">
        ...
        <div class="field"><label>Data de Nascimento</label><input type="date" value="${dep.dataNasc}" onchange="depsData.find(d=>d.id===${dep.id}).dataNasc=this.value;renderDeps()"/></div>
  ...
  list.innerHTML = editDepsData.map((dep, i) => {
    ...
    <div class="dep-card" style="margin-bottom:10px">
      ...
      <div class="grid2" style="margin-top:8px">
        ...
        <div class="field"><label>Data de Nascimento</label><input type="date" value="${dep.dataNasc||''}" onchange="editDepsData[${i}].dataNasc=this.value;_renderEditDepsList()"/></div>
        <div class="field"><label>Sexo</label>
  ...
  edit.innerHTML=`
    ...
    <div class="section"><div class="section-title">Situação e Dados do Sócio</div>
      ...
      <div class="grid2">
        ...
        <div class="field"><label>Data do Acordo</label><input id="e-dataacordo" type="date" value="${s.dataAcordo||''}" onchange="_renderEditDepsList()"/></div>
